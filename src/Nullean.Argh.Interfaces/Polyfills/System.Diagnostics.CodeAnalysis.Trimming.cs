// Polyfill for netstandard2.0 — BCL provides these from .NET 5+.
// Matches dotnet/runtime shape so trim/AOT analyzers recognize metadata.
...
/// <summary>
/// Indicates members accessed dynamically (reflection, DI registration, etc.).
/// </summary>
[AttributeUsage(
